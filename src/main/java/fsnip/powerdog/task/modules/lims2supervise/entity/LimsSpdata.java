...
/**
 * @author kun.tan
 * @description lims抽检数据
 * @date 2018-12-19 17:38:50
 */
@TableName("fsnip_spdata")
public class LimsSpdata extends StatusModel {

    private static final long serialVersionUID = 2910121701350231015L;
    // 检验编号
    @TableId("id")
