 ...
 * @Desc 经营许可基本信息(中间库)
 */
@TableName("fsnip_e_spjyxkxx")
public class CenterLicenseEntity {
   ...
   /* *//**
	...
	public CenterLicenseEntity(SPLicenseEntity licenseEntity) {

	    this.id = licenseEntity.getId();
	    this.businessOperator = licenseEntity.getBusinessOperator();
	    this.socialCreditCode = licenseEntity.getSocialCreditCode();
	    this.legalRepresent = licenseEntity.getLegalRepresent();
	    this.legalRepresentIdCard = licenseEntity.getLegalRepresentIdCard();
	    this.economicNature = licenseEntity.getEconomicNature();
	    this.residence = licenseEntity.getResidence();
	    this.businessPlace = licenseEntity.getBusinessPlace();
	    this.businessPlaceAdmincode = licenseEntity.getBusinessPlaceAdmincode();
	    this.warehouseAddress = licenseEntity.getWarehouseAddress();
	    this.licenseNo = licenseEntity.getLicenseNo();
	    this.mainBodyForm = licenseEntity.getMainBodyForm();
	    this.mainBodyCode = licenseEntity.getMainBodyCode();
	    this.networkBusiness = licenseEntity.getNetworkBusiness();
	    this.websiteAddress = licenseEntity.getWebsiteAddress();
	    this.entityStore = licenseEntity.getEntityStore();
	    this.centralKitchen = licenseEntity.getCentralKitchen();
	    this.chainOperation = licenseEntity.getChainOperation();
	    this.wholeSale = licenseEntity.getWholeSale();
	    this.restaurantScale = licenseEntity.getRestaurantScale();
	    this.refectoryType = licenseEntity.getRefectoryType();
	    this.groupMealDeliveryUnit = licenseEntity.getGroupMealDeliveryUnit();
	    this.useAutoEquipment = licenseEntity.getUseAutoEquipment();
	    this.businessItem = licenseEntity.getBusinessItem();
	    this.otherTypeSale = licenseEntity.getOtherTypeSale();
	    this.otherTypeMakeSale = licenseEntity.getOtherTypeMakeSale();
	    this.bulkCookFoodSale = licenseEntity.getBulkCookFoodSale();
	    this.selfbrewMakeSale = licenseEntity.getSelfbrewMakeSale();
	    this.pastryMakeSale = licenseEntity.getPastryMakeSale();
	    this.selfbrewWineSale = licenseEntity.getSelfbrewWineSale();
	    this.brewWinePackageType = licenseEntity.getBrewWinePackageType();
	    this.brewWineSale = licenseEntity.getBrewWineSale();
	    this.dailySuperviAdminMechanism = licenseEntity.getDailySuperviAdminMechanism();
	    this.dailySuperviAdminPerson = licenseEntity.getDailySuperviAdminPerson();
	    this.valid = licenseEntity.getValid();
	    this.validTill = licenseEntity.getValidTill();
	    this.copyNum = licenseEntity.getCopyNum();
	    this.issuAuthority = licenseEntity.getIssuAuthority();
	    this.issuAuthorityNo = licenseEntity.getIssuAuthorityNo();
	    this.approvalDate = licenseEntity.getApprovalDate();
	    this.newHandleDate = licenseEntity.getNewHandleDate();
	    this.issuer = licenseEntity.getIssuer();
	    this.workerNum = licenseEntity.getWorkerNum();
	    this.physicalExamNum = licenseEntity.getPhysicalExamNum();
	    this.postcode = licenseEntity.getPostcode();
	    this.email = licenseEntity.getEmail();
	    this.mainBodyFormRemark = licenseEntity.getMainBodyFormRemark();
	    this.websiteScreenshot = licenseEntity.getWebsiteScreenshot();
	    this.businessItemRemark = licenseEntity.getBusinessItemRemark();
	    this.diningSeats = licenseEntity.getDiningSeats();
	    this.primaryLicenseId = licenseEntity.getPrimaryLicenseId();
	    this.primaryLicenseNo = licenseEntity.getPrimaryLicenseNo();
	    this.agentId = licenseEntity.getAgentId();
	    this.acceptOrgan = licenseEntity.getAcceptOrgan();
	    this.acceptOrganCode = licenseEntity.getAcceptOrganCode();
	    this.createUser = licenseEntity.getCreateUser();
	    this.applyType = licenseEntity.getApplyType();
	    this.applyTypeName = licenseEntity.getApplyTypeName();
	    this.createTime = licenseEntity.getCreateTime();
	    this.modifyUer = licenseEntity.getModifyUer();
	    this.modifyTime = licenseEntity.getModifyTime();
	    this.businessType = licenseEntity.getBusinessType();
	    this.businessTypeName = licenseEntity.getBusinessTypeName();
	    this.licenseStatus = licenseEntity.getLicenseStatus();
	    this.licenseStatusName = licenseEntity.getLicenseStatusName();
	    this.processStatus = licenseEntity.getProcessStatus();
	    this.processStatusName = licenseEntity.getProcessStatusName();
	    this.layoutAndEquipChange = licenseEntity.getLayoutAndEquipChange();
	    this.certificateDate = licenseEntity.getCertificateDate();
	    this.qRCodeUrl = licenseEntity.getqRCodeUrl();
	    this.recipients = licenseEntity.getRecipients();
	    this.receiveDate = licenseEntity.getReceiveDate();
	    this.callBackOriginalNum = licenseEntity.getCallBackOriginalNum();
	    this.callBackCopyNum = licenseEntity.getCallBackCopyNum();
	    this.changeReason = licenseEntity.getChangeReason();
	    this.isSpecialStep = licenseEntity.getIsSpecialStep();
	    this.processId = licenseEntity.getProcessId();
	    this.complaintCall = licenseEntity.getComplaintCall();
	    this.fileDate = licenseEntity.getFileDate();
	}
